...
5. Tras capturar cada sesión, el script rsync automáticamente las cookies al servidor de despliegue (configurable con la variable `PRESTO_COOKIES_PATH`, ej: `usuario@servidor:~/docker/buscapega/cookies/`).
