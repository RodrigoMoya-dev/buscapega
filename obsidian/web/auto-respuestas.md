...
Catálogo de respuestas que **el usuario define manualmente** para que Buscapega complete los
...
3. Si una respuesta coincide (y su portal corresponde), Buscapega escribe su `texto` en el campo.
